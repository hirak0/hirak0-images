	...
	class Silence {
		constructor() {
			this.defaluts = {
				profile: {
					enable: false,
					avatar: "https://cdn.jsdelivr.net/gh/hirak0/hirak0-images@master/avatar/avatar.png",
					authorName: "信安小萌新"
					favicon: null,
					notice: "念念不忘，必有回响",
				},
				...
				signature: {
					author: null,
					enable: false,
					home: 'https://www.cnblogs.com/hirak0',
					license: 'CC BY 4.0',
				...
				topImg: {
					homeTopImg: [
						"https://cdn.jsdelivr.net/gh/hirak0/hirak0-images@master/bg/20210630-1.jpg",
					],
					notHomeTopImg: [
						"https://cdn.jsdelivr.net/gh/hirak0/hirak0-images@master/bg/20210630-21.jpg"
					]
				},
				topInfo: {
					title: 'Hi,cousin',
		...
		buildCustomElements() {
			...
			$title.html($title.html().replace(`信安小萌新 | ${autherName}`, `${blogTitle}`));
		...
		buildBloggerProfile() {
			...
			var title = '<div class="site-branding">' +
					...
					'<a href="https://www.cnblogs.com/hirak0" alt="信安小萌新">' +
					'<ruby><span class="sakuraso">hirak0</span><span class="no">の</span><span class="shironeko">Blog</span>' +
					'<rt class="chinese-font">信安小萌新</rt></ruby></a></span>' +
					'</div>'
			$('body').prepend(title);
